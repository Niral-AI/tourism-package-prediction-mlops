...
from sklearn.metrics import accur%%writefile tourism_project/model_building/train.py
import os
import joblib
import pandas as pd
import xgboost as xgb
...
def train_model():
    ...
    for model_name, config in models.items():
        ...
        with mlflow.start_run(run_name=f"{model_name}_tuning"):
            ...
            # Explicitly pass skops_trusted_types to prevent serialization blocking for both numpy and XGBoost
...
if __name__ == "__main__":
    train_model()acy_score, f1_score, roc_auc_score
